...
const assets = {
  ...
  'gaze-top-right': require('@/assets/gaze top right.mov'),
  'gaze-bottom-left': require('@/assets/gaze bottom left.mov'),
  'gaze-bottom-right': require('@/assets/gaze bottom right.mov'),
  'face-left': require('@/assets/look left.mov'),
  'face-right': require('@/assets/look right.mov'),
  'face-top-left': require('@/assets/look top left.mov'),
  'face-top-right': require('@/assets/look top right.mov'),
  'face-bottom-left': require('@/assets/look bottom left.mov'),
  'face-bottom-right': require('@/assets/look bottom right.mov'),
  'point-left': require('@/assets/pointing left.mov'),
  'point-right': require('@/assets/pointing right.mov'),
  'point-top-left': require('@/assets/pointing top left.mov'),
  'point-top-right': require('@/assets/pointing top right.mov'),
  'point-bottom-left': require('@/assets/pointing bottom left.mov'),
  'point-bottom-right': require('@/assets/pointing bottom right.mov'),
  'shining-left': require('@/assets/shining left.mov'),
  'shining-right': require('@/assets/shining right.mov'),
  'shining-top-left': require('@/assets/shining top left.mov'),
  'shining-top-right': require('@/assets/shining top right.mov'),
  'shining-bottom-left': require('@/assets/shining bottom left.mov'),
  'shining-bottom-right': require('@/assets/shining bottom right.mov'),
  drag: require('@/assets/drag.mov'),
  'drag-success': require('@/assets/drag-success.mov'),
  'tap-negative': require('@/assets/tap negative.mov'),
  'tap-positive': require('@/assets/positive tap.mov'),
